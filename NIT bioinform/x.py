...
# Check if 'height' and other columns exist
required_columns = ['height', 'weight', 'ap_hi', 'ap_lo']

for col in required_columns:
    if col not in data.columns:
        print(f"Column '{col}' is missing in the dataset.")
        # Here you can add code to handle the missing column or exit
        exit()
...
final_data.to_csv('/path/to/final_dataset.csv', index=False)
